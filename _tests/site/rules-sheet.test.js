...
const GAMES=["tic-tac-toe","mystery-word","matchstick-math","lights-out","spot-the-words","juice-jumble","dino-dig","mirror-draw","tally-chart","balance-scales","circuit-builder","connect-four","checkers"];
